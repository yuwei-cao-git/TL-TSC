...
commands=(
    # all head
    "python train_fuse.py --data_dir '/mnt/g/ovf/ovf_superpixel_dataset_v2' --config 'configs/config_ovf_genus.yaml' --pc_normal True --task 'tsc' --log_name 'all_head_unet_pointnetb_ovf_genus_normal_lr1e4_wmse_cosine' --gpus 1 --batch_size 16 --head 'all_head' --dataset 'ovf_genus' --network 'Unet' --lr 1e-4 --loss_func 'wmse'"
