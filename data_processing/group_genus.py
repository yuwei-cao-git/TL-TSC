...
def save_genus_files(indices, split_name, file_paths, dst_folder, cfg):
    ...
    for idx in indices:
        ...
        genus_label, genus_pixel = group_to_genus(
            data["label"],
...
def main():
    ...
    # Save NPZ files
    print("Saving data...")
    save_genus_files(train_idx, "train", files, args.out, cfg)
    save_genus_files(val_idx, "val", files, args.out, cfg)
    save_genus_files(test_idx, "test", files, args.out, cfg)
