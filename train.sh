...
commands=(
    ...
    "python train_fuse.py --data_dir '/mnt/g/rmf' --config 'configs/config_rmf.yaml' --task 'tsc' --log_name 'test' --gpus 1 --batch_size 16 --head 'fuse_head' --dataset 'rmf' --encoder 'l' --network 'ResUnet' --lr 1e-3 --optimizer 'adam' --scheduler 'steplr' --loss_func 'mse' --pc_normal False"

    "python train_fuse.py --data_dir '/mnt/g/rmf_superpixel_dataset' --config 'configs/config_rmf.yaml' --task 'pc_tsc' --log_name 'test' --gpus 1 --batch_size 16 --head 'fuse_head' --dataset 'rmf_sp' --encoder 'l' --network 'ResUnet' --lr 1e-3 --optimizer 'adam' --scheduler 'steplr' --loss_func 'mse' --pc_normal False"
    )
