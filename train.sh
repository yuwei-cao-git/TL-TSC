...
commands=(
    ...
    "python train_fuse.py --data_dir '/mnt/g/ovf/ovf_superpixel_dataset' --config 'configs/config_ovf.yaml' --log_name 'all_head_unet_pointnetb_ovf_sp_normal_lr1e4_wmse_cosine_pretrained_rmf_sp_normal' --gpus 1 --batch_size 8 --head 'all_head' --dataset 'ovf_sp' --network 'Unet' --lr 1e-4 --loss_func 'wmse' --pretrained_ckpt 'tl_logs/all_head_unet_pointnetb_rmf_sp_normal_lr1e4_wmse_cosine/checkpoints/final_model.ckpt'"
